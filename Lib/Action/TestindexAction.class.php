...
class TestindexAction extends Action {
    public function index() {
        ...
        $this->assign('all_sites', $curBranches);
        $this->assign('all_modules', $allBranches);
    ...
    public function sites() {
        $modules = $this->_getModules();
        $sites = $this->_getSites($modules);
        $this->assign('all_sites', $sites);
        $this->display('Data/sites.json.tpl');
    }
