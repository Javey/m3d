...
require_once('CSSProperties.php');
require_once('CSSList.php');
require_once('CSSRuleSet.php');
require_once('CSSRule.php');
require_once('CSSValue.php');
require_once('Settings.php');
require_once('CSSException.php');
...
//        return $aStack[0];
    ...
    private static function listDelimiterForRule($sRule) {
        if (preg_match('/^font($|-)/', $sRule)) {
            return array(',', '/', ' ');
        } else if (preg_match('/filter/', $sRule)) {
            // By zoujiawei
            return array(':', '.', ',', ' ', '/');
        }
        return array(',', ' ', '/');
